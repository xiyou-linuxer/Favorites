...
- [epoll的边沿触发模式(ET)真的比水平触发模式(LT)快吗？](https://www.zhihu.com/question/20502870)
- [epoll LT/ET](https://segmentfault.com/a/1190000004597522)
...
- [linux socket 端口复用 SO_REUSEADDR](https://blog.csdn.net/whatday/article/details/104598200)
- [什么时候应该使用 TCP_NODELAY，什么时候应该使用 TCP_CORK？](https://stackoverflow.com/questions/3761276/when-should-i-use-tcp-nodelay-and-when-tcp-cork)
